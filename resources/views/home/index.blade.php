...
<div class="container-fluid" style="margin-top: 75px">
    <div class="row">
      ...
      <div
        class="col-1"
        style="background-color: #edaf19; height: 20px"
      ></div>
      <div
        class="col-1"
        style="background-color: #edd219; height: 20px"
      ></div>
      <div
        class="col-1"
        style="background-color: #329b1e; height: 20px"
      ></div>
      <div
        class="col-1"
        style="background-color: #1463a7; height: 20px"
      ></div>
      <div
        class="col-1"
        style="background-color: #9e479b; height: 20px"
      ></div>
      <div
        class="col-1"
        style="background-color: #d03d6b; height: 20px"
      ></div>
      <div
        class="col-1"
        style="background-color: #f39bf8; height: 20px"
      ></div>
      <div
        class="col-1"
        style="background-color: #6acdf0; height: 20px"
      ></div>
      <div
        class="col-1"
        style="background-color: #7f6226; height: 20px"
      ></div>
      <div
        class="col-1"
